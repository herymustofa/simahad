                    ...
                    <?php foreach ($ijin as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                if ($r['status'] == 0) {
                                    ?>
                                        <a href="<?= base_url('musrifah/approval/') . $r['id'] ?>" class="btn btn-warning btn-sm">Approval</a>
                                        <a href="<?= base_url('musrifah/not_approval/') . $r['id'] ?>" class="btn btn-danger btn-sm">Tolak</a>
                                <?php
                                } else {
                                    echo "";
                                }
